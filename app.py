...
# from src.pip.train_pipeline import TraininingPipeline
...
def upload():
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            return render_template('D:/ML_projects/wafer_fault_prediction/Wafer_fault_prediction/templates/upload_file.html')
    except Exception as e:
        raise CustomException(e,sys)
